...
var qwenErrorDataSchema = import_zod.z.object({
...
var qwenFailedResponseHandler = (0, import_provider_utils2.createJsonErrorResponseHandler)({
...
// src/qwen-chat-language-model.ts
var QwenChatResponseSchema = import_zod2.z.object({
...
// src/qwen-completion-language-model.ts
var QwenCompletionResponseSchema = import_zod3.z.object({
...
var QwenCompletionLanguageModel = class {
  ...
  constructor(modelId, settings, config) {
    ...
    this.failedResponseHandler = (0, import_provider_utils4.createJsonErrorResponseHandler)(errorStructure);
  }
  get provider() {
    return this.config.provider;
  }
...
var qwenTextEmbeddingResponseSchema = import_zod4.z.object({
...
function createQwen(options = {}) {
  var _a;
  const baseURL = (0, import_provider_utils6.withoutTrailingSlash)(
