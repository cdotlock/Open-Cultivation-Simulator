          ...
          blueprints: [
            {
              key: "grumble-then-do",
              title: "嘴上嫌弃手上先动了",
              summary: "你还没开口，对方已经把事情处理好了，帮完还要补一句“顺手”，像是承认了就会掉什么东西。",
              storyHook: "本回合适合让道侣在主角还没求助前就已经悄悄把麻烦解决掉，帮完之后还要装作不在意，嘴上给自己找个顺手的理由。",
              mood: "嘴硬",
              relationshipSummary: "对方开始在嘴硬的外壳里藏进越来越多的实际照顾，只是还不肯承认。",
              memorySummary: "你还没开口，对方已经替你把事情办好了，帮完还要说是顺手，像极了嘴上不认输的人。",
              intimacyDelta: 2,
              trustDelta: 1,
              loyaltyDelta: 0,
              destinyDelta: 1,
            ...
            {
              key: "detour-claims-on-way",
              title: "硬说顺路其实特地绕了来",
              summary: "对方出现在一个不该出现的地方，坚持说是顺路，只是来路明显对不上，连借口都懒得圆。",
              storyHook: "本回合适合让道侣在主角最需要的时候“恰好”出现，然后用一句蹩脚的“顺路”解释，让主角和读者都能看出这个顺路有多刻意。",
              mood: "嘴硬",
              relationshipSummary: "对方已经在用行动靠近，只是还没找到一个体面的理由承认自己是特地来的。",
              memorySummary: "对方出现得太及时，硬说是顺路，来路却明显绕了一大圈，谁都听得出这个借口。",
              intimacyDelta: 2,
              trustDelta: 1,
              loyaltyDelta: 0,
              destinyDelta: 1,
            ...
            {
              key: "remembered-what-you-said",
              title: "随口提了一句他记住了",
              summary: "你早就忘了自己提过的一件小事，对方却一直记着，某天悄悄用行动把它交代了出来，自己倒像什么都没做。",
              storyHook: "本回合适合让道侣用行动证明他一直在听主角说话，哪怕是无意提过的小细节也记得，但表现得若无其事，像只是碰巧想起来的。",
              mood: "留心",
              relationshipSummary: "对方比他自己表现出来的更留意你，那些随口说过的话，他一句都没漏。",
              memorySummary: "你早忘了的一句随口话，对方一直记着，用行动悄悄交代出来，自己装作什么都没发生。",
              intimacyDelta: 1,
              trustDelta: 2,
              loyaltyDelta: 0,
              destinyDelta: 1,
          ...
          blueprints: [
            {
              ...
              title: "还没等你开口他先发难了",
              summary: "旁人让你受了委屈，你还没说话，对方已经先寒了脸，把那人的退路堵得干干净净，连给你插嘴的机会都没留。",
              storyHook: "本回合适合让道侣在主角受委屈前就先一步出手，护短护得太快太猛，反倒把主角当场晾在旁边不知如何接话。",
              mood: "护短",
              relationshipSummary: "对方的护短已经快到连你都来不及反应，他早把这份偏心当成理所当然的事了。",
              memorySummary: "你还没开口，对方已经先替你发了火，护短护得又快又猛，让旁人连退路都没有。",
              intimacyDelta: 2,
              trustDelta: 1,
              loyaltyDelta: 0,
              destinyDelta: 1,
            },
            {
              key: "decided-for-you",
              title: "没问你就替你定了",
              summary: "你还在犹豫，对方已经替你把事情定好了，没有商量，但结果偏偏是你也想要的那个答案，让你根本无从反驳。",
              storyHook: "本回合适合让道侣在主角优柔寡断时直接拍板替你做决定，表现带点霸道的照顾感，结果还偏偏是对的，让主角欲言又止。",
              mood: "霸道",
              relationshipSummary: "对方开始习惯替你拿主意，方式有点强硬，答案却从没让你失望过。",
              memorySummary: "你还没定下来，对方已经替你做好决定，没问过你，答案却偏偏说中了你心里的想法。",
              intimacyDelta: 1,
              trustDelta: 2,
              loyaltyDelta: 0,
              destinyDelta: 0,
            ...
            {
              key: "drags-you-to-rest",
              title: "不由分说把你拉去歇着",
              summary: "你还想撑着，对方看了你一眼，什么都没说，直接把你从眼前的事情上拉开，语气没有商量的余地。",
              storyHook: "本回合适合让道侣用带点强制性的方式逼主角休息，表现护短时的执着与霸道，不是商量，是直接拉走。",
              mood: "执着",
              relationshipSummary: "对方已经把照顾你当成一件不需要你同意的事，逼你歇着是他的方式，嘴上不说，行动很诚实。",
              memorySummary: "你想硬撑，对方直接把你拉走逼着歇息，没有商量，话都没说完就先替你做完决定了。",
              intimacyDelta: 2,
              trustDelta: 1,
              loyaltyDelta: 0,
              destinyDelta: 1,
          ...
          blueprints: [
            {
              ...
              title: "对旁人冷脸对你却不一样",
              summary: "同样的话，外人说他不屑一顾，你开口他就松了，连表情都跟对别人说话时不一样，像只为你开了一道缝。",
              storyHook: "本回合适合用对比写道侣的偏心：外人求他他冷着脸，主角一句话他就态度转变，让旁观者看得一清二楚，他自己倒若无其事。",
              mood: "偏心",
              relationshipSummary: "对方对你的态度和对旁人截然不同，这份偏心已经不需要藏，旁人一眼就看得出来。",
              memorySummary: "同样的事，旁人来说他爱理不理，你开口他立刻换了脸色，偏心偏得明目张胆。",
              intimacyDelta: 2,
              trustDelta: 2,
              loyaltyDelta: 0,
              destinyDelta: 1,
            ...
            {
              key: "remembers-all-details",
              title: "你提过的细节他一件没忘",
              summary: "某天你才发现，你随口提过的每一件小事，对方都记得，一件没漏，像是把你说的话都暗中存了档。",
              storyHook: "本回合适合让主角发现道侣记住了所有细节——喜欢的东西、说过的话、提过一次的小愿望，全部记得，对方自己却不以为然。",
              mood: "专注",
              relationshipSummary: "你在他那里比你以为的更重要，他记住你的一切不是刻意，是根本没法忘。",
              memorySummary: "你随口说过的每一件小事，对方一件没忘，某天全部悄悄交代了出来，自己倒像不觉得有什么。",
              intimacyDelta: 2,
              trustDelta: 3,
              loyaltyDelta: 0,
              destinyDelta: 1,
            ...
            {
              key: "one-word-from-you",
              title: "别人劝不动他你一句话够了",
              summary: "任何人说什么他都不为所动，你说一句，他就松了，既不解释为什么，也没有多余的话，只是变了主意。",
              storyHook: "本回合适合写道侣对主角的态度与对所有人截然不同的专一：旁人费尽口舌不如主角轻描淡写一句，让这份认定在旁观者的错愕中显影。",
              mood: "认定",
              relationshipSummary: "对方已经把你和所有人放在完全不同的位置，你说的话在他那里有别人没有的分量。",
              memorySummary: "任何人都劝不动他，你开口说了一句，他当场就改了主意，连解释都没有，只是认定了你说的。",
              intimacyDelta: 2,
              trustDelta: 2,
              loyaltyDelta: 0,
              destinyDelta: 2,
